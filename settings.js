...
global.owner = process.env.OWNER_NUMBER  || '254759725733 ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=bAVwhJAY#FfXv-gFEFCVR5ld0Nvam4xyf5RR-tMzQI1VnekS59v0 ' ,
